...
import { useActionItem, useCompleteActionItem, useDeleteActionItem } from '@/hooks/use-action-items';
...
export default function ActionItemDetailPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      ...
      <ConfirmDialog open={deleteOpen} onOpenChange={setDeleteOpen} title="Delete Action Item" description="This cannot be undone." variant="destructive" confirmLabel="Delete" onConfirm={() => { deleteItem.mutate(id); router.push('/accountability/action-items'); }} />
    </div>
  );
}
